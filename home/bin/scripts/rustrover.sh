...
# ---------------------------------------------------------------------
IDE_BIN_HOME="/home/vanta/programming/rustrover/RustRover-232.9921.46/bin"
IDE_HOME="/home/vanta/programming/rustrover/RustRover-232.9921.46"
...
if [ -z "$JRE" ] && [ -s "${CONFIG_HOME}/JetBrains/RustRover2023.2/rustrover.jdk" ]; then
  USER_JRE=$(cat "${CONFIG_HOME}/JetBrains/RustRover2023.2/rustrover.jdk")
...
if [ -n "$RUSTROVER_VM_OPTIONS" ] && [ -r "$RUSTROVER_VM_OPTIONS" ]; then
  ...
  elif [ -r "${CONFIG_HOME}/JetBrains/RustRover2023.2/rustrover64.vmoptions" ]; then
    USER_VM_OPTIONS_FILE="${CONFIG_HOME}/JetBrains/RustRover2023.2/rustrover64.vmoptions"
  fi
fi
