    ...
    profiles.vanta = {
      ...
      userChrome = ''
        ...
        #tabbrowser-tabs:first-child {
          padding-left: 2px !important; // this always bothers me idk why its just slightly closer 
        }
        .tab-background {
           border-radius: 8px !important; // matches tabs border radius to the windows.
        }

        // the rest of this is from: https://github.com/JarnotMaciej/Essence
        ...
        */
        ...
        /* Panel/menu position -- disabled to keep menu on the right */
        #PanelUI-button {
