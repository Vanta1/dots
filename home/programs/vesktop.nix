    ...
    xdg.configFile."vesktop/themes/midnight.theme.css".text = ''
        ...
        */
        ...
        :root {
                ...
                --bg-4: #1e2326; /* main background color */
                ...
                --moon-icon-url: url('https://upload.wikimedia.org/wikipedia/commons/b/b7/Font_Awesome_5_regular_snowflake.svg'); /* custom icon url */
                --moon-icon-size: auto;
